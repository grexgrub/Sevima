  <nav class="sidebar shadow-lg bg-white border-gray-200 text-gray-500" id="sidebar">
      <ul class="navbar-nav">
        ...
        <li class="navbar-item">
          <a href="{{route('guru.dashboard')}}" data-tooltip-placement='right' data-tooltip-target="tooltip-myartikel" class="navbar-link  hover:bg-gray-300 {{ $title == 'Materi' ? 'bg-gray-300' : '' }}">
            <i class="fa-solid fa-book link-icon {{ $title == 'Materi' ? 'active' : ''}}"></i>
            <span class="link-text text-gray-500" ><strong>Materi</strong></span>
          </a>
          <a href="{{route('guru.buatmateri')}}" data-tooltip-placement='right' data-tooltip-target="tooltip-buatartikel" class="navbar-link {{ $title == 'buatmateri' ? 'bg-gray-300' : ''}}  hover:bg-gray-300">
            <i class="fa-solid fa-pen-to-square link-icon {{ $title == 'buatmateri' ? 'active' : ''}}"></i>
