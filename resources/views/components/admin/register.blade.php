<div class="mb-6">
    <div class="pilihan-login border border-blue-300 bg-blue-200 flex p-1 self-center rounded-sm">
        ...
        <{{$type}} href="{{route('admin.register')}}" class="flex-grow bg-blue-499 hover:bg-blue-300 flex justify-center {{$type == 'a' && $title == 'Admin-register' ? 'bg-blue-500' : '' }} items-center rounded-sm" type="button" id="murid-btn" type="button">Register</{{$type}}>
    </div>
