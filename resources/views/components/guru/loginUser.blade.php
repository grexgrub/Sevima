    ...
    <div class="pilihan-login w-10/12 h-4/12 border border-blue-300 bg-blue-200 flex p-1 self-center rounded-sm">
        ...
        <{{$type}} href="{{route('guru.register')}}" class="flex-grow bg-blue-499 hover:bg-blue-300 flex justify-center items-center rounded-sm" type="button" id="murid-btn" type="button">Register</{{$type}}>
    </div>
